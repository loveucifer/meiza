...
pub fn export_spice(circuit: &Circuit) -> anyhow::Result<String> {
...
fn create_net_mapping(circuit: &Circuit) -> HashMap<String, String> {
    ...
    for component in &circuit.components {
        ...
        match component.component_type {
            ComponentType::SignalGround
            | ComponentType::ChassisGround
...
fn component_to_spice(
    ...
    match &component.component_type {
        ...
        _ => {
            ...
            spice_line.push_str(&format!(
                "* Component {} of type {:?} not supported in SPICE export",
...
fn normalize_resistance_value(value: &str) -> anyhow::Result<String> {
...
fn normalize_capacitance_value(value: &str) -> anyhow::Result<String> {
    let value = value.trim();
...
fn normalize_inductance_value(value: &str) -> anyhow::Result<String> {
    let value = value.trim();
...
fn normalize_voltage_value(value: &str) -> anyhow::Result<String> {
    let value = value.trim();
...
fn normalize_current_value(value: &str) -> anyhow::Result<String> {
    let value = value.trim();
...
fn get_diode_model(component: &Component) -> anyhow::Result<String> {
